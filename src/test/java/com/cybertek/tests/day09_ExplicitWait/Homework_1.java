...
public class Homework_1 {
     ...
     *     1. observe : the code works great when header element found ,
     *     but forced to wait for 10 seconds of implicit wait when element not found
     *     2. use Explicit wait technic we learned to minimize the wait time to 2 seconds max
     *     by waiting accoridng to expected condition of header element is visible : `visibilityOfElementLocated` condition
     *
     *
     ...
     *    2. The method check the welcome message right beside `logout` link contains username or not.
     *    for example `Welcome , Tester` contains `Tester`
